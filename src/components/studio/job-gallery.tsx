  ...
  if (jobs.length === 0) {
    return (
      <div className="flex h-full min-h-[320px] flex-col items-center justify-center px-8 text-center">
        <div className="mb-4 flex size-14 items-center justify-center rounded-full border border-gold/25 bg-gold/8">
          <span className="font-display text-2xl text-gold italic">P</span>
        </div>
        <h2 className="font-display text-2xl italic">{emptyTitle}</h2>
